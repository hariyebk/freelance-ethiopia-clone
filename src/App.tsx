...
import {About, Job, Faq, Help, Login, Signup, Home, NotFound, Register, Profile, ProfileSetUp, Applied, SavedJobs, Settings, MyPosts, Post, PostDetails, JobSeekerProfile, Apply, VerifyPhoneNumber, PostDescriptions, EditPost, PrivacyPolicy } from "./pages"
                ...
                <Route element = {<AppLayout />}>
                    ...
                    <Route element = {
                      <EmployersOnly />
                            ...
                            <Route path="/post/:id/applications" element={<PostDetails />} />
                            <Route path="/edit-post/:id" element={<EditPost />} />
                            <Route path="/profile" element = {<EmployerProfile />} />
                            <Route path="/applicant/:id/profile" element = {<JobSeekerProfile />} />
                    </Route>
                    </Route>
                </Route>
