...
export default function About() {
    return (
        <div className="max-container flex flex-col items-start min-h-screen my-24 max-lg:mx-5 max-lg:text-justify mx-56">
            <h1 className="text-6xl text-secondary font-palanquin mx-auto"> About Us </h1>
            <div className="flex flex-1 flex-col">
                <p className="mt-16 mb-8 max-lg:text-sm text-base text-zinc-700 font-montserrat"> We are a fully dedicated team working to make the job market in Ethiopia better. Using our advanced digital platforms, we are on the way to becoming a place where work is redefined. We provide a reasonably priced platform for employers where they come to find competent employers. We enable the employers to post different job types so the people can have a variety of work in their realm. We are proud to be home for all kinds of jobs. </p>
                <span className="font-bold text-zinc-700 text-lg font-palanquin mt-3"> Our story / How it all started </span>
                <p className="mb-8 mt-3 max-lg:text-sm text-base text-zinc-700 font-montserrat">
