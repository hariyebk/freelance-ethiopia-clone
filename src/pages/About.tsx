    ...
    return (
        <div className="max-container flex flex-col items-start min-h-screen lg:my-40 max-lg:mt-40 max-lg:mb-36 max-lg:mx-8 max-lg:text-justify mx-72">
            ...
            <div className="flex flex-1 flex-col">
                <p className="max-lg:mt-10 mt-16 mb-8 max-lg:text-sm text-justify text-base text-zinc-700 font-montserrat"> We are a fully dedicated team working to make the job market in Ethiopia better. Using our advanced digital platforms, we are on the way to becoming a place where work is redefined. We provide a reasonably priced platform for employers where they come to find competent employers. We enable the employers to post different job types so the people can have a variety of work in their realm. We are proud to be home for all kinds of jobs. </p>
                <span className="font-bold text-zinc-700 text-lg font-palanquin mt-3"> Our story / How it all started </span>
                <p className="mb-8 mt-6 max-lg:text-sm leading-6 text-justify text-base text-zinc-700 font-montserrat">
                ...
                <span className="font-bold text-zinc-700 text-lg mt-3 font-palanquin"> The road so far,</span>
                <p className="mb-8 mt-6 leading-6 text-justify max-lg:text-sm text-base text-zinc-700 font-montserrat">
                ...
                <p className="mb-8 mt-3 leading-6 text-justify max-lg:text-sm text-base text-zinc-700 font-montserrat">
                ...
                <span className="font-bold text-zinc-700 text-lg mt-3 font-palanquin"> Our mission </span>
                <ul className="mb-10 mt-3 list-disc ml-5 max-lg:text-sm text-base text-zinc-700 font-montserrat">
                    <li> Creating an easy, cost efficient, time saving and fully automated digital hiring platform for companies.</li>
                    <li> We are striving with a mission to create an effective and efficient communication hub for employers to find the best potential professionals.</li>
                    <li> Achieving accurate job match by creating a positive externality in the job market. </li>
                    <li> Build an ecosystem for professionals and business owners. </li>
                </ul>
                <span className="font-bold text-zinc-700 text-lg mt-3 font-palanquin"> Our vision </span>
                <p className="mt-3 max-lg:text-sm text-base text-zinc-700 font-montserrat">
