...
export default function JobSeekerCard({isHorizontal}: JobSeekerCardProps) {
    return (
        <Link to="/help/job-seeker" className={`${isHorizontal ? "hover:-translate-y-5 hover:translate transition duration-700 pt-10 px-20" : "w-[600px] h-[135px] mx-auto  flex items-center gap-10 pl-11 pt-3"} bg-white w-[300px] h-[250px] border rounded-md shadow-lg hover:border hover:border-primary z-10`}>
