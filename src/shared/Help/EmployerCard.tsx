...
export default function EmployerCard({isHorizontal}: EmployerCardProps){
    return (
        <Link to="/help/employer" className={`${isHorizontal ? "hover:-translate-y-5 hover:translate transition duration-700 px-24 pt-10" : "w-[600px] h-[125px] mx-auto flex items-center gap-10 pl-5"} bg-white w-[300px] h-[250px] border rounded-md shadow-lg hover:border hover:border-primary z-10`}>
