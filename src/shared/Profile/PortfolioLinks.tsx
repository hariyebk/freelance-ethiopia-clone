...
export default function PortfolioLinks() {
    ...
    return (
        <section className="w-[260px] flex items-start gap-4 rounded-xl shadow-lg border border-gray-300 py-5 pl-5">
            ...
            <button className="text-sm text-red-500 font-palanquin font-semibold" onClick={() => setEditProfile(true)}> Edit </button>
        </section>
    )
}
