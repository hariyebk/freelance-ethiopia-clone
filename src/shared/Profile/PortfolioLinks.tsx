...
export default function PortfolioLinks() {
    ...
    return (
        <section className="max-lg:w-full w-[260px] flex items-start justify-between lg:rounded-xl lg:shadow-lg lg:border lg:border-gray-300 max-lg:px-10 max-lg:mt-5 py-5 pl-5">
