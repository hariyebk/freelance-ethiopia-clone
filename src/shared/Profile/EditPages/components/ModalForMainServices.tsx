    ...
    return (
        <div className="flex flex-col items-start lg:mx-6 gap-5">
            <div className="w-fulll flex flex-col space-y-4">
                ...
                <select className="mt-5 focus:outline-none border border-stone-500 lg:px-5 py-2">
            ...
            <button className="w-full mt-8 rounded-full bg-gradient-to-r from-primary to-secondary px-8 py-2 text-white text-base"> Add Services </button>
        </div>
    )
}
