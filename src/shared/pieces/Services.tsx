    ...
    return (
        <div className="max-lg:w-full w-[900px] max-lg:my-10 my-20 max-lg:px-10 max-lg:pt-5 shadow-lg border rounded-xl max-lg:h-auto h-auto pb-6 flex max-lg:flex-col lg:gap-5">
                <div className="flex flex-col mt-7 ml-7 mb-7">
                    ...
                    <div className="max-lg:flex max-sm:flex-col max-sm:gap-2 max-sm:items-start items-center gap-2.5 max-lg:my-2">
                ...
                <div className="flex flex-col gap-3 my-7 sm:px-8 text-sm font-palanquin">
                    ...
                    <Link to="tel:+251956666667" className="max-lg:text-base text-sm flex max-sm:items-start items-center gap-2 hover:text-primary"> 
                        <IoMdMail  className = "max-sm:text-xs sm:text-sm md:text-base" />
